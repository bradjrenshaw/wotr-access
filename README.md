...
### Where you are
A few keys keep you oriented. Press z for "where am I" (your current area, the room you're standing in, and whether that spot is still unexplored), x for the mod's authored description of your surroundings where one exists, k to hear the movement cursor's exact position, and shift k to hear your party.
