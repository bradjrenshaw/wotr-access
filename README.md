...
You can also quickly cycle the review cursor through various things around you. Pressing period cycles enemies, comma allies, m interactables, n neutral units, b points of interest, v room exits. The review cursor allows you to quickly interact with various things while simultaneously moving the movement cursor.
...
### Where you are
A few keys keep you oriented. Press y for "where am I" (your current area and the part of it you're standing in), k to hear the movement cursor's exact position, and shift k to hear your party.
