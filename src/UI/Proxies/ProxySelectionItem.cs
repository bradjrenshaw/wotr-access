...
namespace WrathAccess.UI.Proxies
{
    ...
    /// <b>radio button</b> (default); pass <c>role</c> "tab" for a tab, or "toggle" for a multi-select
    /// group (announces on/off instead of selected). <c>available</c> overrides the default
